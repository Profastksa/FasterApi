...
#invoice-template-large{
    background-color:white;margin-left: 30% !important;margin-right: 35% !important;margin-bottom: 35px !important;
}
        @media print {
...
@section('content')
    <div>
        <button class="btn btn-info m-2" onclick="printInvoice()">طباعه</button>
        <br />
        <br />
        <div class="invoice-print"> <!-- Add class for printing -->
            ...
            @foreach ($Orders as $order)
                ...
                @for ($i = 1; $i <= $order->number_of_pieces; $i++)
                    <div style="" id="invoice-template-large" class="" >
        ...
        <br />
        <button class="btn btn-info" onclick="printInvoice()">طباعه</button>
