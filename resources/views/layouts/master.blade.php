...
document.addEventListener('DOMContentLoaded', function () {
            ...
            livewire.on('ErrorException' ,  (text) => {
                let text2 = (text != null ? text:'{{ __('translation.exeception_try_again') }}');
                Swal.fire({
                    icon: 'error',
                    title: '{{ __('translation.opps') }}',
                    text: text2,
                    });
            });

            livewire.on('Success' ,  (text) => {
                let text2 = (text != null ? text:'{{ __('translation.operation_done_sccuess') }}');
                Swal.fire({
                    icon: 'success',
                    title: '{{ __('translation.opration_done') }}',
                    text: text2,
                    });
            });
